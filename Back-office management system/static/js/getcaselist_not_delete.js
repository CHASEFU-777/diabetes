function getundeluserList() {
    $.ajax({
      ...
      method: 'GET',
      url: 'http://81.70.0.177:3007/my/users/undelusers',
      headers: {
      ...
      success: function (res) {
        ...
        $.each(res.data, function (i, item) {
          ...
          var str = '<tr><td align="center"><input type="checkbox" id="'+(i+1+(nowpage-1)*10)+'"></td><td align="center">'+item.id+'</td><td align="center">'+item.username+'</td><td align="center">'+item.nickname+'</td><td align="center">'+item.date+'</td><td align="center">'+item.sex+'</td><td align="center">'+item.email+'</td><td align="center">'+item.birthday+'</td><td align="center">'+item.province+'</td><td align="center">'+item.is_delete+'</td></tr>'
  ...
  function getdeluserList() {
    $.ajax({
      ...
      method: 'GET',
      url: 'http://81.70.0.177:3007/my/users/delusers',
      headers: {
        'Authorization': localStorage.getItem('itheima No1. ^_^')
    },
      success: function (res) {
        ...
        $.each(res.data, function (i, item) {
          ...
          var str = '<tr><td align="center"><input type="checkbox" id="'+item.id+'" ></td><td align="center">'+item.id+'</td><td align="center">'+item.username+'</td><td align="center">'+item.nickname+'</td><td align="center">'+item.date+'</td><td align="center">'+item.sex+'</td><td align="center">'+item.email+'</td><td align="center">'+item.birthday+'</td><td align="center">'+item.province+'</td><td align="center">'+item.is_delete+'</td></tr>'
   ...
   $('#btn_delete').click(function(){
    ...
    $.ajax({
     ...
     if(confirm( '是否确认删除选中账号')){
        $.ajax({
            method:'POST',
            url:'http://81.70.0.177:3007/my/users/deleteusers',
   ...
   $('#btn_reuse').click(function(){
    ...
    $.ajax({
     ...
     if(confirm( '是否确认删除选中账号')){
        $.ajax({
            method:'POST',
            url:'http://81.70.0.177:3007/my/users/recoverusers',
