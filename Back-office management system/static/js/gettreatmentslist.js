    ...
    // alert(localStorage.getItem('itheima No1. ^_^'))
      var page = location.search.substring(1);
        $.ajax({
          ...
          method: 'POST',
          url: `http://127.0.0.1:8080/api/treatment?page=${page}`,
        //   headers: {
        ...
        // },
          success: function (res) {
            ...
            $.each(res.data, function (i, item) {
              ...
              var str = '<tr><td align="center">'+(i+1+(nowpage-1)*10)+'</td><td align="center">'+item.Type+'</td><td align="center">'+item.Site+'</td><td align="center">'+item.Treatment+'</td><td align="center"><a href="change-users.html?'+item.id+'" class="change" data-id="'+item.id+'">修改</a>&nbsp;&nbsp;&nbsp;<a href="javascript:;" class="del" data-id="'+item.id+'">'+a+'</a></td></tr>'
              rows.push(str)
            })
